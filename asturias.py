...
shp_urls = {
    ...
    "PARRES": "PARRES",
    "PESOZ": "PESOZ",
    "PEÑAMELLERA ALTA": "PEÑAMELLERA ALTA",
    ...
    "RIOSA": "RIOSA",
    "SALAS": "SALAS",
    "SAN MARTIN DE OSCOS": "SAN MARTIN DE OSCOS",
    "SAN MARTIN DEL REY AURELIO": "SAN MARTIN DEL REY AURELIO",
...
def cargar_shapefile_desde_github(municipio_file):
    base_url = f"https://raw.githubusercontent.com/iberiaforestal/AFECCIONES_ASTURIAS/master/CATASTRO/{municipio_file}/"
...
def generar_pdf(datos, x, y, filename):
    ...
    if not os.path.exists(logo_path):
        ...
        st.markdown(
            "Descárgalo aquí: [logos.jpg](https://raw.githubusercontent.com/iberiaforestal/AFECCIONES_ASTURIAS/master/logos.jpg)"
        )
        logo_path = None
    else:
        pass
...
st.image(
    "https://raw.githubusercontent.com/iberiaforestal/AFECCIONES_ASTURIAS/master/logos.jpg",
